            ...
            <div class="col-md-6">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Add a new color</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.colors.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    placeholder="e.g., Bright red" required>
                                @error('name')
                            ...
                            <div class="form-group">
                                <label for="code">Color code (Hex or CSS)</label>
                                ...
                                @error('code')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                                <small class="form-text text-muted">You can enter a hex code or use the color picker.</small>
                            </div>
