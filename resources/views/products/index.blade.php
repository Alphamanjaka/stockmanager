                ...
                <table class="table table-hover table-striped mb-0 align-middle">
                    <thead class="table-light">
                        <tr>
                            ...
                            {{-- cost price --}}
                            <th>
                                <a href="{{ request()->fullUrlWithQuery(['sort' => 'price_purchase', 'order' => request('order') === 'asc' ? 'desc' : 'asc']) }}"
                                    class="text-dark text-decoration-none">
                                    Cost Price <i
                                        class="fas fa-sort{{ request('sort') == 'price_purchase' ? (request('order') == 'asc' ? '-up' : '-down') : '' }} small text-muted"></i>
                                </a>
                            </th>
                            {{-- prix de vente --}}
                            <th>
                    ...
                    <tbody>
                        @forelse ($productVariants as $item)
                            <tr>
                                ...
                                <td class="text pe-4">
                                    {{ number_format($item->price_purchase, 2) }} MGA
                                </td>
                                <td class="text pe-4">
                                    {{ number_format($item->price, 2) }} MGA
                                </td>
